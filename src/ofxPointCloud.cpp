...
void ofPointCloud::setFrameNumber(int _frameNumber){
    frameNumber = _frameNumber;
} 

int ofPointCloud::getFrameNumber(){
    return frameNumber;
}

void ofPointCloud::setSavePath(string _path){
    path = _path;
}    

string ofPointCloud::getSavePath(){
    return path;
}

void ofPointCloud::saveRaw(){
...
bool ofPointCloud::loadRaw(const string& _path){
